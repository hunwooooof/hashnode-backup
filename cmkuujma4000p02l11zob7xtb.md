---
title: "Vue 工廠 ── 從模板到畫面，Vue 的渲染機制是什麼？（下）"
seoTitle: "Vue 工廠 ── 從模板到畫面，Vue 的渲染機制是什麼？（下）"
...
因為有了這些像作弊一樣的更新標記，當運行到這個元素時，只會檢查這些 props 是否有更新，不會沒事去檢查其他根本不可能更新的 props。這種檢查方式，稱作**位運算**。
